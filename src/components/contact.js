...
function Contact() {
  return (<>
      <div
        className="container-fluid mt-5  px-sm-5 text-white"
            ...
            <div className="row">
              ...
              <div className="col-lg-4 col-md-6 col-sm-6">
                ...
                <ul className="list-unstyled fs-5">
                  <li>
                    {" "}
                    <a className="text-decoration-none text-white" href="#void">
                  ...
                  <li>
                    <a className="text-decoration-none text-white" href="#void">
                      <i className="fa-brands fa-linkedin me-2"></i>Linkdin
                    </a>{" "}
                  </li>
                </ul>
              </div>
        ...
        <div className="jumbotron py-4 ">
          <p className="m-0 ">
            ...
            <a
              ...
              href="https://www.youtube.com/channel/UCc5GjlNTdSV4ZZCsX61mccg"
            >
              PraRoz Channel{" "}
            </a>
          </p>
