...
function CinemaHallSetting() {
  ...
  const initialscreen = {
    name: "",
    screen: { name: "", movie: "", seatBooked: [], seatHolded: [] },
    address: [{ city: "", place: "" }],
  };
  ...
  useEffect(() => {
    axios
      .get(
        "https://guvi-hackathon2-backend-vva7.onrender.com/home/showcinemahall/admin",
        {
          headers: {
            token: jwtToken,
          },
  ...
  const removeScreen = (screen) => {
    axios
      .delete(
        `https://guvi-hackathon2-backend-vva7.onrender.com/deletecinemahall/admin/${screen._id}`,
        {
          headers: {
            token: jwtToken,
          },
  ...
  const onFormSubmitted = (e) => {
    ...
    axios
      .post(
        "https://guvi-hackathon2-backend-vva7.onrender.com/addcinemahall/admin",
        screens,
        {
          headers: {
            token: jwtToken,
  ...
  const updatechange = () => {
    axios
      .put(
        "https://guvi-hackathon2-backend-vva7.onrender.com/updatecinemahall/admin",
        screens,
        {
          headers: {
            token: jwtToken,
              ...
              <form className="user-form " onSubmit={onFormSubmitted}>
                <div className="container ">
                  <div className="row text-start">
                    ...
                    <div className="col">
                      {" "}
                      <label htmlFor="screenName" className="label-control">
                        screenName:{" "}
                      </label>
                      <br />
                      <input
                        ...
                        className="input-control"
                        name="screenName"
                        onChange={inputChangeHandlerScreen}
                        value={screens.screen.name}
                      ></input>
                    </div>

                    <div className="col">
                      <label htmlFor="movie" className="label-control">
                        Screening-movie{" "}
                      </label>
                      <br />
                      <input
                        ...
                        name="movie"
                        onChange={inputChangeHandlerScreen}
                        value={screens.screen.movie}
                      ></input>
                    </div>
                    <div className="col">
                      <label htmlFor="seatBooked" className="label-control">
                        seatBooked{" "}
                      </label>
                      <br />
                      <input
                        ...
                        className="input-control"
                        name="seatBooked"
                        onChange={inputChangeHandlerSeat}
                        value={screens.screen.seatBooked}
                      ></input>
                    </div>

                    <div className="col">
                      <label htmlFor="seatHolded" className="label-control">
                        seatHolded{" "}
                      </label>
                      <br />
                      <input
                        ...
                        name="seatHolded"
                        onChange={inputChangeHandlerSeat}
                        value={screens.screen.seatHolded}
                      ></input>
                    </div>
                    ...
                    <div className="col">
                      ...
                      <input
                        ...
                        value={screens.address[0].city}
                      ></input>
                    </div>

                    <div className="col">
                      <label htmlFor="place" className="label-control">
                        Place:{" "}
                      </label>
                      <br />
                      <input
