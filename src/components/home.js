...
function Home() {
  ...
  useEffect(() => {
    axios
      .get(
        `https://guvi-hackathon2-backend-vva7.onrender.com/home/showmovies/${user}`,
        {
          headers: {
            token: jwtToken,
          },
  ...
  useEffect(() => {
    axios
      .get(
        `https://guvi-hackathon2-backend-vva7.onrender.com/home/showcinemahall/${user}`,
        {
          headers: {
            token: jwtToken,
          },
  ...
  return (<div className="home">
      ...
      <div
        ...
        className="carousel carousel-dark slide mt-4 px-5 shadow-md "
      ...
      >
        ...
        <div className="carousel-inner">
          <div className="carousel-item ">
            <img
              className="d-block  imagecarousel rounded rounded-2   "
          ...
          <div className="carousel-item active" data-bs-interval="500">
            <img
              className="d-block imagecarousel rounded rounded-2 "
              src="https://images.pexels.com/photos/3692639/pexels-photo-3692639.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1"
              alt="Second slide"
            />
          </div>
          <div className="carousel-item">
