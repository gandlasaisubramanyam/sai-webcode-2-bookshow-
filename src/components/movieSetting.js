...
function MovieSetting() {
  ...
  useEffect(() => {
    axios
      .get(
        "https://guvi-hackathon2-backend-vva7.onrender.com/showallmovies/admin",
        {
          headers: {
            token: jwtToken,
          },
  ...
  const removeMovie = (movieList) => {
    axios
      .delete(
        `https://guvi-hackathon2-backend-vva7.onrender.com/deletemovie/admin/${movieList._id}`,
        {
          headers: {
            token: jwtToken,
          },
  ...
  const onFormSubmitted = (e) => {
    ...
    axios
      .post(
        "https://guvi-hackathon2-backend-vva7.onrender.com/addmovie/admin",
        movie,
        {
          headers: {
            token: jwtToken,
  ...
  const updatechange = () => {
    ...
    axios
      .put(
        "https://guvi-hackathon2-backend-vva7.onrender.com/updatemovies/admin",
        movie,
        {
          headers: {
            token: jwtToken,
              ...
              <div className=" row mt-5 " key={index}>
                <div className="col-9 d-flex  me-auto">
                  <div className=" col-12 row text-start ms-3">
                    ...
                    {movieList.cast.map((castmebers, index) => (
                      <div
                        className=" col text-nowrap text-start me-3"
                        key={index}
                      >
                        <span>{castmebers.name}|</span>
                        <span>{castmebers.profession}</span>
                      </div>
                    ))}

                    <hr />

                    {movieList.crew.map((castmebers, index) => (
                      <div
                        className=" col text-nowrap  text-start me-3"
                        key={index}
                      >
            ...
            <form className="user-form " onSubmit={onFormSubmitted}>
              <div className="container ">
                <div className="row text-start">
                  ...
                  <div className="col">
                    {" "}
                    <label htmlFor="rating" className="label-control">
                      Rating:{" "}
                    </label>
                    <br />
                    <input
                  ...
                  <div className="col">
                    <label htmlFor="launguage" className="label-control">
                      Launguage{" "}
                    </label>
                    <br />
                    <input
                      ...
                      name="launguage"
                      onChange={inputChangeHandler}
                      value={movie.launguage}
                    ></input>
                  </div>
                  <div className="col">
                    <label htmlFor="genere" className="label-control">
                      Genere{" "}
                    </label>
                    <br />
                    <input
                  ...
                  <div className="col">
                    <label htmlFor="certified" className="label-control">
                      Certified{" "}
                    </label>
                    <br />
                    <input
                      ...
                      <div key={index}>
                        <div className="col ">
                          ...
                          <input
                            ...
                            className="input-control"
                            name="name"
                            onChange={(e) => inputChangeHandlerCast(e, index)}
                            value={movie.cast[`${index}`]["name"]}
                          ></input>
                        </div>

                        <div className="col">
                          <label htmlFor="profession" className="label-control">
                            Profession:{" "}
                          </label>
                          <br />
                          <input
                            ...
                            name="profession"
                            onChange={(e) => inputChangeHandlerCast(e, index)}
                            value={movie.cast[`${index}`]["profession"]}
                          ></input>
                        </div>
                      </div>
                    ))}
                      ...
                      <div key={index}>
                        <div className="col">
                          ...
                          <input
                            ...
                            className="input-control"
                            name="name"
                            onChange={(e) => inputChangeHandlerCrew(e, index)}
                            value={movie.crew[`${index}`].name}
                          ></input>
                        </div>
                        ...
                        <div className="col ">
                          ...
                          <input
                            ...
                            name="profession"
                            onChange={(e) => inputChangeHandlerCrew(e, index)}
                            value={movie.crew[`${index}`].profession}
                          ></input>
                        </div>
                      </div>
                    ))}
