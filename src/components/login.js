...
function Login() {
  ...
  const formdata = useFormik({
    ...
    onSubmit: (userdata) => {
      axios
        .post(
          "https://guvi-hackathon2-backend-vva7.onrender.com/login",
          userdata
        )
        .then((response) => {
          ...
          <div className="col-xl-6 col-lg-7 col-md-8 col-sm-9 col-12 ms-auto my-auto ">
            <div className="card  border-0 shadow-lg ">
              <div className="card-body p-0">
                <div className="row">
                  <img
                    className="img-fluid col-lg-6 col d-none d-md-block  "
                    src={LoginBanner}
                    alt="none"
                  />
                    ...
                    >
                      ...
                      <div className="form-group mb-2">
                        <div className="custom-control custom-checkbox small ">
                          <input
                            type="checkbox"
                            className="custom-control-input ms-3 me-1 "
                            id="customCheck"
                          />
                          <label
                      ...
                      <button
                        className="btn btn-primary d-block rounded-pill mb-3 w-75 mx-auto "
                        type="submit"
                      >
                        Login
                      </button>
                      ...
                      <Link
                        to="/register"
                        className=" btn btn-danger rounded-pill mb-3 w-75 mx-auto "
                      >
