  ...
  return (<>
      <nav className="navbar navbar-expand-lg navbar-transparent ">
        <div className="container-md ">
          <a className="navbar-brand" href="/home#Movies">
            <img
              src={Logo}
              alt="here logo"
              className="img-thumbnail bg-dark img-fluid w-50"
            />
          </a>
          <button
          ...
          <div className="collapse navbar-collapse " id="mynavbar">
            <ul className="navbar-nav  text-start text-nowrap ">
              ...
              <li className="nav-item">
                <a
                  className="nav-link"
                  href="/home#Cinemahall"
                  onClick={viewCinemaHall}
                >
                  Cinema Hall
                </a>
              </li>
            ...
            <form className="d-flex mt-1 ms-auto text-nowrap">
              ...
              >
                log out
                <i className="fa-solid fa-user-check ms-2" />
              </button>
              {admin ? (
                <button
                  className="btn btn-primary fw-bold ms-1 gear"
                  onClick={adminAccess}
                  type="button"
                >
